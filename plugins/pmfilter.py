...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @cryxelys
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('Hᴇʟᴘ ⚙️', callback_data='main'),
                    InlineKeyboardButton('Aʙᴏᴜᴛ ✌️', callback_data='about')
                ],[
                    InlineKeyboardButton('Pʀᴇᴍɪᴜᴍ 💳', callback_data="premium_info"),
                    InlineKeyboardButton('♻️ Exᴛʀᴀ Fᴇᴀᴛᴜʀᴇꜱ ✅', callback_data='help')
                ],[
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(6762558871))
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• ᴏᴡɴᴇʀ •', user_id=int(6762558871)),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        if settings["button"]:
            ...
            for idx, file in enumerate(files[:500]):
                cap += f"<b>{idx + 1}. <a href='https://telegram.me/{temp.U_NAME}?start={file.file_id}'>[{get_size(file.file_size)}] {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file.file_name.split()))}\n\n</a></b>"
